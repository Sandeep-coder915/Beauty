...
export default function AboutUs({ darkMode }) {
  ...
  {[
    ...
    <div key={index} className="text-center shadow-lg p-6 rounded-2xl hover:shadow-2xl transition ">
      ...
      <p className="mt-2 font-semibold  ">"{founder.motto}"</p>
    </div>
  ))}
</div>
      ...
      <div className="p-6 rounded-2xl ">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-6">
          {[
            ...
            <div key={index} className="p-4 rounded-2xl shadow-lg flex items-center space-x-4 hover:scale-105 transition-transform  ">
