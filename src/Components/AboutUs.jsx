...
export default function AboutUs({ darkMode }) {
  return (
    <div className='max-w-6xl mx-auto p-6 space-y-10 ' >
      {/* Hero Section */}
      {/* <div className="relative w-full h-96 bg-cover bg-center rounded-2xl flex items-center justify-center text-center text-white" style={{ backgroundImage: "url('/images/about-hero.jpg')" }}>
        <div className="bg-black bg-opacity-50 p-6 rounded-2xl">
          <h1 className="text-5xl font-bold  text-pink-400">About Beauty at Home</h1>
          <p className="text-lg mt-2">Bringing professional beauty care to your doorstep.</p>
        </div>
      </div> */}
